...
[PLDR-LLMs Reason At Self-Organized Criticality](./pldrllm-self-organized-criticality.pdf).
...
Large Language Model From Power Law Decoder Representations is a deductive-inductive LLM that utilizes the decoder layers that were first developed for [Power Law Graph Transformer (PLGT)](https://arxiv.org/abs/2107.02039). It was first introduced in the research article: [PLDR-LLM: Large Language Model From Power Law Decoder Representations](https://arxiv.org/abs/2410.16703). PLDR-LLM with KVG cache implementation in Pytorch framework was studied in the research article: [ PLDR-LLMs Learn A Generalizable Tensor Operator That Can Replace Its Own Deep Neural Net At Inference](https://arxiv.org/abs/2502.13502).
...
- The PLDR-LLMs that were pretrained and studied in the research paper titled ["PLDR-LLMs Reason At Self-Organized Criticality"](./pldrllm-self-organized-criticality.pdf) can be found at [huggingface.co/fromthesky](https://huggingface.co/fromthesky).
